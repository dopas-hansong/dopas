...
<body>
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="breadcrumb form-search">
		...
		&nbsp;&nbsp;<label>描述 ：</label><form:input path="desciption" htmlEscape="false" maxlength="50" class="input-medium"/>
		...
		<c:forEach items="${page.list}" var="dict">
			<tr>
				...
				<shiro:hasPermission name="sys:dict:edit"><td>
    				...
    				<a href="<c:url value='${fns:getAdminPath()}/sys/dict/form?type=${dict.type}'><c:param name='desciption' value='${dict.desciption}'/></c:url>">添加键值</a>
